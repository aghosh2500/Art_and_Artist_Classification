...
def home_page():
    ...
    <div class="about-section">
        ...
        <p>I'm <strong>Advait Ghosh</strong>, a high schooler from the Bay Area. This project uses deep learning models to classify art and artists, addressing a critical issue facing the creative community today. The artist community has experienced tremendous stress in recent years, with ongoing lawsuits highlighting the challenges they face in protecting their work and intellectual property.</p>
        <p>Beyond the broader impact, this project holds personal significance for me—I've been doing art my whole life, which has given me a deep appreciation for the struggles artists encounter. This personal connection, combined with the urgent need to develop tools that can help protect and attribute artistic work, motivated me to tackle this problem with machine learning.</p>
    </div>
    """, unsafe_allow_html=True)
